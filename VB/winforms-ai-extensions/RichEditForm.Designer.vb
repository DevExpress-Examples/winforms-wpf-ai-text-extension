...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.behaviorManager1.SetBehaviors(Me.richEditControl1, New DevExpress.Utils.Behaviors.Behavior() {DevExpress.AIIntegration.WinForms.ExpandBehavior.Create(GetType(DevExpress.AIIntegration.WinForms.RichEditExpandBehaviorSource)), DevExpress.AIIntegration.WinForms.ShortenBehavior.Create(GetType(DevExpress.AIIntegration.WinForms.RichEditShortenBehaviorSource)), DevExpress.AIIntegration.WinForms.SummarizeBehavior.Create(GetType(DevExpress.AIIntegration.WinForms.RichEditSummarizeBehaviorSource), DevExpress.AIIntegration.SummarizationMode.Abstractive), DevExpress.AIIntegration.WinForms.ExplainBehavior.Create(GetType(DevExpress.AIIntegration.WinForms.RichEditExplainBehaviorSource)), DevExpress.AIIntegration.WinForms.ChangeToneBehavior.Create(GetType(DevExpress.AIIntegration.WinForms.RichEditChangeToneBehaviorSource)), DevExpress.AIIntegration.WinForms.ProofreadBehavior.Create(GetType(DevExpress.AIIntegration.WinForms.RichEditProofreadBehaviorSource)), DevExpress.AIIntegration.WinForms.ChangeStyleBehavior.Create(GetType(DevExpress.AIIntegration.WinForms.RichEditChangeStyleBehaviorSource)), DevExpress.AIIntegration.WinForms.TranslateBehavior.Create(GetType(DevExpress.AIIntegration.WinForms.RichEditTranslateBehaviorSource), New DevExpress.AIIntegration.WinForms.LanguageInfo() {languageInfo1, languageInfo2, languageInfo3}), DevExpress.AIIntegration.WinForms.CustomRequestBehavior.Create(GetType(DevExpress.AIIntegration.WinForms.RichEditCustomRequestBehaviorSource)), DevExpress.AIIntegration.WinForms.GenerateImageDescriptionBehavior.Create(GetType(DevExpress.AIIntegration.WinForms.RichEditGenerateDescriptionBehaviorSource))})
            Me.richEditControl1.Dock = DockStyle.Fill
            Me.richEditControl1.Location = New Point(0, 231)
            Me.richEditControl1.Margin = New Padding(2, 2, 2, 2)
            ...
            Me.ribbonControl1.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.repositoryItemFontEditRichEdit1, Me.repositoryItemRichEditFontSizeEdit1})
            Me.ribbonControl1.Size = New Size(1421, 231)
            ' 
            ' undoItem1
            ' 
            Me.undoItem1.Id = 1
            ...
            Me.galleryChangeStyleItem1.Gallery.ImageSize = New Size(97, 70)
            ...
            Controls.Add(Me.richEditControl1)
            Controls.Add(Me.ribbonControl1)
