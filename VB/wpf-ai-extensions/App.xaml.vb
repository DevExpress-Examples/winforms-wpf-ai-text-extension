...
Namespace WPF_AI_Extensions
    ...
    Public Partial Class App
        ...
        Protected Overrides Sub OnStartup(ByVal e As StartupEventArgs)
            ...
            Dim azureOpenAIClient As IChatClient = New AzureOpenAIClient(New Uri(AzureOpenAIEndpoint), New System.ClientModel.ApiKeyCredential(AzureOpenAIKey)).AsChatClient(DeploymentName)
        End Sub
    End Class
End Namespace
